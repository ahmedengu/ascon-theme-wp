...
get_header(); ?>
                            ...
                            <?php while ($services->have_posts()) : $services->the_post(); ?>
                                <div class="col-md-4">
                                    <div class="icon bg-crete">
                                        <span class="fa <?php echo get_post_meta(get_the_ID(), 'icon', true); ?>"
                                              data-animation-1 data-animation-trigger-1="hover"
                                              data-animation-type-1="bounce"></span>
                                    </div>
                                    <h4><?php the_title(); ?></h4>
                                    <?php the_content(); ?>
                                </div>
    ...
    <section class="content-block gallery-1 gallery-1-1">
        ...
        <div class="container">
            <div class="underlined-title">
                <h1 data-animation-1 data-animation-trigger-1="hover"
                    data-animation-type-1="bounce"><?php echo get_theme_mod('blocks_gallery_1_1_title', __('Our work', 'ascontheme')); ?></h1>
                <hr>
            </div>
            <ul class="filter">
                <li class="active">
            ...
            <div class="row">
                <div class="isotope-gallery-container">
                    <?php foreach ($gallery['images'] as $image) : ?>
                        <div
                            class="col-md-3 col-sm-6 col-xs-12 gallery-item-wrapper <?php echo $image['tags_string'] ?>">
                            <div class="gallery-item">
                                <div class="gallery-thumb">
                                    <img src="<?php echo $image['thumbnail'][0] ?>" class="img-responsive"
                                         alt="<?php echo $image['thumbnail']['alt'] ?>">
                                    <div class="image-overlay"></div>
                                    <a href="<?php echo $image['image'][0] ?>" class="gallery-zoom"
                                       alt="<?php echo $image['alt'] ?>"><i class="fa fa-eye"
                                                                            alt="This is the title"></i></a>
                                    <a href="<?php echo $image['link'] ?>" class="gallery-link" target="_blank"><i
                            ...
                            <div class="row">
                                ...
                                <?php if ($clients->have_posts()) : ?>
                                    <?php while ($clients->have_posts()) : $clients->the_post(); ?>
                                        <div class="col-md-2 col-sm-4" data-animation-1 data-animation-trigger-1="hover"
                                             data-animation-type-1="bounce">
            ...
            <div class="row">
                ...
                <?php if ($blocks->have_posts()) : ?>
                    ...
                    <?php while ($blocks->have_posts()) : $blocks->the_post(); ?>
                        <div class="col-md-3 col-sm-6 team-member-wrap" data-animation-1
                             data-animation-trigger-1="hover" data-animation-type-1="pulse">
                                ...
                                <div class="team-details">
                                    ...
                                    <ul class="social social-dark">
                                        <?php if (get_post_meta(get_the_ID(), 'social_facebook', true)) : ?>
                                            <li>
                                                <a href="<?php echo get_post_meta(get_the_ID(), 'social_facebook', true); ?>"><i
                                                        class="fa fa-2x fa-facebook"></i></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if (get_post_meta(get_the_ID(), 'social_twitter', true)) : ?>
                                            <li>
                                                <a href="<?php echo get_post_meta(get_the_ID(), 'social_twitter', true); ?>"><i
                                                        class="fa fa-2x fa-twitter"></i></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if (get_post_meta(get_the_ID(), 'social_google', true)) : ?>
                                            <li>
                                                <a href="<?php echo get_post_meta(get_the_ID(), 'social_google', true); ?>"><i
                                                        class="fa fa-2x fa-google-plus"></i></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if (get_post_meta(get_the_ID(), 'social_pinterest', true)) : ?>
                                            <li>
                                                <a href="<?php echo get_post_meta(get_the_ID(), 'social_pinterest', true); ?>"><i
                                                        class="fa fa-2x fa-pinterest"></i></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if (get_post_meta(get_the_ID(), 'social_behance', true)) : ?>
                                            <li>
                                                <a href="<?php echo get_post_meta(get_the_ID(), 'social_behance', true); ?>"><i
                                                        class="fa fa-2x fa-behance"></i></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if (get_post_meta(get_the_ID(), 'social_dribbble', true)) : ?>
                                            <li>
                                                <a href="<?php echo get_post_meta(get_the_ID(), 'social_dribbble', true); ?>"><i
                                                        class="fa fa-2x fa-dribbble"></i></a>
                                            </li>
                                        <?php endif; ?>
                                    </ul>
                                    <!-- /.social -->
    ...
    <div class="map min-height-500px" data-map-lat="<?php echo get_theme_mod('blocks_map_lat'); ?>"
         data-map-long="<?php echo get_theme_mod('blocks_map_long'); ?>"
         data-map-zoom="<?php echo get_theme_mod('blocks_map_zoom'); ?>"
         data-marker-image="<?php echo esc_url(get_template_directory_uri() . '/images/map-pin.png') ?>"></div>
