...
<header id="header-3" class="soft-scroll header-3">
    ...
    <section class="hero"
             style="<?php if ($image_attributes) echo 'background-image:url(\'' . $image_attributes[0] . '\')' ?>">
        <div class="container">
            <div class="brand">
            ...
            <div class="col-md-8 col-md-offset-2 text-center">
                <div class="editContent">
                    <h1 data-animation-1 data-animation-trigger-1="load"
                        data-animation-type-1="bounce"><?php echo get_theme_mod('blocks_header_3_title', __('ASCON', 'ascontheme')); ?></h1>
                </div>
                <div class="editContent">
            ...
            <div class="col-md-6 col-md-offset-3 text-center">
                <div class="col-md-6">
                    <a href="<?php echo esc_url(get_theme_mod('blocks_header_3_button1_url')); ?>"
                       class="btn btn-info btn-block" data-animation-1 data-animation-trigger-1="hover"
                       data-animation-type-1="bounce"><?php echo get_theme_mod('blocks_header_3_button1_label', __('services', 'ascontheme')); ?></a>
                </div>
                <div class="col-md-6">
                    <a href="<?php echo esc_url(get_theme_mod('blocks_header_3_button2_url')); ?>"
                       class="btn btn-danger btn-block" data-animation-1 data-animation-trigger-1="hover"
                       data-animation-type-1="bounce"><?php echo get_theme_mod('blocks_header_3_button2_label', __('Contact us', 'ascontheme')); ?></a>
                </div>
            </div>
        </div>
    </section>
